...
import com.forezp.newszh.presenter.UserPresenter;
 ...
 */
public class AnswerActivity extends BaseActivity  implements IUserInfoView{
...
//            }
//        });
        voteNum=getIntent().getStringExtra("vote");
...
//        Logger.d("" + userURL);
    ...
    private void setListener() {
        user_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //    bundle.putSerializable("user",mUserDetail);
    ...
    private void getUserInfo() {
        userPresenter.loadUserInfo(userURL);
...
//        executeRequest(request4UserDetail);
    ...
    @Override
    public void onUserInfoSuccess(UserDetail userDetail) {
        mUserDetail=userDetail;
        avatar.setImageURI(Uri.parse(userDetail.getAvatar()));
        userName.setText(userDetail.getName());
        voteNumber.setText(voteNum);

    }

    @Override
    public void onUserInfoFail(String msg) {
        T.show(AnswerActivity.this,msg);
    }
